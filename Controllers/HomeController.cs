...
namespace HomeApi.Controllers
{
    ...
    public class HomeController : ControllerBase
    {
        ...
        [Route("info")] //Настройка маршрутов с помощью атрибутов
        public IActionResult Info()
        {
            // Объект Stringbuilder, в который будем "собирать" результат из конфигурации
            // var pageResult = new StringBuilder();
            var infoResponce = _mapper.Map<HomeOptions, InfoResponse>(_options.Value);
            ...
            */
            ...
            return StatusCode(200, infoResponce);
        }
